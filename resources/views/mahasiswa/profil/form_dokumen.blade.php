<div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="formDocument" method="POST" action="/dokumen" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control form-control-sm" name="path_file" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" required>
