    ...
    <div class="col-md-12">
        ...
        <div class="mb-3">
            <table class="table table-sm table-borderless">
                <tr>
                    <th width="35%">Nama</th>
                    <td>{{ $magang->lamaran->mahasiswa->nama }}</td>
                </tr>
                <tr>
                    <th>NIM</th>
                ...
                <tr>
                    <th>Email</th>
                    <td>{{ $magang->lamaran->mahasiswa->email ?? '-' }}</td>
                </tr>
                <tr>
                    <th>No. HP</th>
        ...
        @if ($magang->lamaran->mahasiswa->pengalamanKerja->count() > 0)
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        @foreach ($magang->lamaran->mahasiswa->pengalamanKerja as $pengalaman)
                            <tr>
        ...
        @if ($magang->lamaran->mahasiswa->dokumen->count() > 0)
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($magang->lamaran->mahasiswa->dokumen as $dokumen)
                            <tr>
