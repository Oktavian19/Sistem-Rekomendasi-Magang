...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-primary" onclick="modalAction('{{ url('program-studi/create-ajax') }}')">
            <i class="bx bx-plus"></i> Tambah Program Studi
        </button>
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table id="table-program-studi" class="table table-bordered table-striped w-100">
                <thead>
                    <tr>
                        <th>No</th>
